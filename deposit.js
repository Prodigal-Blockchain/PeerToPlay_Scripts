async function main() {
    ...
    const connector = new web3.eth.Contract(ABI, '0x6daAa1bA7FcDa6D9030d873005F820a4CD9f143A');

    const tokenAddr='0x07865c6E87B9F70255377e024ace6630C1Eaa37F';
    const market='0x3EE77595A8459e93C2888b13aDB354017B198188';
    const amountWei = "5000000";
    const encodedFunctionCall = connector.methods.deposit(market,tokenAddr,amountWei,0,0).encodeABI();
