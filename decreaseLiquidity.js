async function main() {
    ...
    const tokenId=77579;
    const liquidity="14727748769567077528";
    const amtAMin="9999999999999999996";
    const amtBMin="4402140425574513520";
    const encodedFunctionCall = connector.methods.withdraw(tokenId,liquidity,amtAMin,amtBMin,0,[0,0]).encodeABI();
